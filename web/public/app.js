  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "app-menu" }, /*#__PURE__*/
      React.createElement("div", { class: "search" }, /*#__PURE__*/
        React.createElement("input", { type: "text", className: "textinput", placeholder: 'url...' }), /*#__PURE__*/
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "list-item-wraper" }, /*#__PURE__*/
      React.createElement("div", { class: "list-item" }, /*#__PURE__*/
        ...
        React.createElement("span", null, props.title), /*#__PURE__*/
...
function Playlist(props) {
  return /*#__PURE__*/(
    React.createElement("div", { className: "playlist" },
      props.queue.map((e, i) => /*#__PURE__*/
        React.createElement(PlaylistItem, { key: e.id, id: i + 1, title: e.title }))));
...
function App() {
  ...
  const refresh = () => {
    fetch("../player/queue").
      then(r => r.json()).
      then(json => {
          setCurrentTrack(json.currentTrack)
      ...
      React.createElement("main", null, /*#__PURE__*/
        React.createElement("section", { className: "app-main" }, /*#__PURE__*/
          React.createElement(MediaView, {
            ...
            disc: currentTrack.author,
            img: currentTrack.thumbnail
          }), /*#__PURE__*/

          React.createElement(Playlist, { queue: queue }))), /*#__PURE__*/
